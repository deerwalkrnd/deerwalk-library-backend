...
from app.modules.auth.presentation.v1.router.auth_router import \
...
from app.modules.books.presentation.v1.router.books_router import \
...
from app.modules.files.presentation.v1.router.files_router import \
...
from app.modules.users.presentation.v1.router.users_router import \
