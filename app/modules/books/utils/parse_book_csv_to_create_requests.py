...
async def parse_book_csv_to_create_requests(file: UploadFile) -> List[CreateBookRequest]:
    ...
    processed_csv = await csv_JSON_parser(rows=list_csv_reader, header=["copies", "genres"])
