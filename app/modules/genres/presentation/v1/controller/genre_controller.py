...
from app.modules.genres.domain.requests.genre_create_request import CreateGenreReqeust
from app.modules.genres.domain.requests.genre_list_params import GenreListParams
from app.modules.genres.domain.requests.genre_update_request import GenreUpdateRequest
from app.modules.genres.domain.usecases.create_genre_use_case import CreateGenreUseCase
from app.modules.genres.domain.usecases.delete_genre_by_id_use_case import (
    DeleteGenreByIdUseCase,
)
from app.modules.genres.domain.usecases.get_genre_by_id_use_case import (
    GetGenreByIdUseCase,
)
from app.modules.genres.domain.usecases.get_many_genre_use_case import (
    GetManyGenreUseCase,
)
from app.modules.genres.domain.usecases.update_genre_by_id_use_case import (
