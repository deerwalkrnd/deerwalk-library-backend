...
class TeacherRecommendationRepository(
    Repository[TeacherRecommendationModel, TeacherRecommendation],
    TeacherRecommendationRepositoryInterface,
):
    def __init__(self, db: AsyncSession):
        super().__init__(
            db=db, model=TeacherRecommendationModel, entity=TeacherRecommendation
        )
