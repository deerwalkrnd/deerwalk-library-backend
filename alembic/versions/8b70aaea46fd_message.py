...
Revision ID: 8b70aaea46fd
Revises: 
Create Date: 2025-09-18 11:37:24.780309
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_book_copies_unique_identifier'), 'book_copies', ['unique_identifier'], unique=False)
    ...
    op.create_index(op.f('ix_book_reviews_review_text'), 'book_reviews', ['review_text'], unique=False)
