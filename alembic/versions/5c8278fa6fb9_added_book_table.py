...
def upgrade() -> None:
    ...
    op.alter_column(
        "teacher_recommendations", "name", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
    ...
    op.alter_column(
        "teacher_recommendations", "note", existing_type=sa.VARCHAR(), nullable=True
    )
    op.alter_column(
        "teacher_recommendations",
        "book_title",
...
def downgrade() -> None:
    ...
    op.alter_column(
        "teacher_recommendations", "note", existing_type=sa.VARCHAR(), nullable=False
    )
    op.alter_column(
        "teacher_recommendations",
        "designation",
    ...
    op.alter_column(
        "teacher_recommendations", "name", existing_type=sa.VARCHAR(), nullable=False
    )
