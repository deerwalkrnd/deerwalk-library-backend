...
Revision ID: da335a04d706
Revises:
Create Date: 2025-10-13 15:44:03.105457
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "fine_status", sa.Enum("UNPAID", "PAID", name="finestatus"), nullable=False
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("book_copy_id", "user_id", name="uq_book_copy_user"),
    )
    op.create_index(
        op.f("ix_book_borrows_book_copy_id"),
        "book_borrows",
        ["book_copy_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_book_borrows_user_id"), "book_borrows", ["user_id"], unique=False
    )
